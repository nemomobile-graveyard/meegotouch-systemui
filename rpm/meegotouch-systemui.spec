...
ln -s ../meegotouch-systemui.service %{buildroot}%{_libdir}/systemd/user/user-session.target.wants/meegotouch-systemui.service
# << install post
...
%{_libdir}/systemd/user/user-session.target.wants/meegotouch-systemui.service
%{_bindir}/sysuid
