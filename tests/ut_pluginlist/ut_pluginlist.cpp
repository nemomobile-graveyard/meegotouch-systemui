...
void Ut_PluginList::testInitialization()
{
    ...
    QCOMPARE(loadedPlugins.count(), 7);
    ...
    QCOMPARE(loadedPlugins.at(5), QDir(DUISTATUSINDICATORMENU_PLUGIN_DIR "/libvolume.so").canonicalPath());
    QCOMPARE(loadedPlugins.at(6), QDir(DUISTATUSINDICATORMENU_PLUGIN_DIR "/libaccessories.so").canonicalPath());
